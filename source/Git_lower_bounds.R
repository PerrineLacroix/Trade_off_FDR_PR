...
lower_bounds <- function(detail,true_beta_matrix,n,p,cste_mult_vect,sigma_2,path_collection,path_collection_bounds,list_P_2r){
  q = min(n,p)
  set.seed(1234)
  ...
  for (k in 1:ncol(true_beta_matrix)){
    ...
    for (K in cste_mult_vect){
      ...
      for (it in 1:nbr_it_bound){
        # known variance
        lower_bound_hat_one_dataset_K2[[it]] <- c(lower_bound_hat_one_dataset_K2[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =2,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_K3[[it]] <- c(lower_bound_hat_one_dataset_K3[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =3,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_K2.5[[it]] <-  c(lower_bound_hat_one_dataset_K2.5[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =2.5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_K3.5[[it]] <- c(lower_bound_hat_one_dataset_K3.5[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =3.5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_K1.5[[it]] <- c(lower_bound_hat_one_dataset_K1.5[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =1.5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_K1[[it]] <- c(lower_bound_hat_one_dataset_K1[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =1,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_Klog_n[[it]] <- c(lower_bound_hat_one_dataset_Klog_n[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =log(n),sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_K4[[it]] <- c(lower_bound_hat_one_dataset_K4[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =4,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_K4.5[[it]] <- c(lower_bound_hat_one_dataset_K4.5[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =4.5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        lower_bound_hat_one_dataset_K5[[it]] <- c(lower_bound_hat_one_dataset_K5[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=TRUE))
        # unknown variance
        lower_bound_hat_one_dataset_K2_slope[[it]] <- c(lower_bound_hat_one_dataset_K2_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =2,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_K3_slope[[it]] <- c(lower_bound_hat_one_dataset_K3_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =3,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_K2.5_slope[[it]] <-  c(lower_bound_hat_one_dataset_K2.5_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =2.5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_K3.5_slope[[it]] <- c(lower_bound_hat_one_dataset_K3.5_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =3.5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_K1.5_slope[[it]] <- c(lower_bound_hat_one_dataset_K1.5_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =1.5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_K1_slope[[it]] <- c(lower_bound_hat_one_dataset_K1_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =1,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_Klog_n_slope[[it]] <- c(lower_bound_hat_one_dataset_Klog_n_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =log(n),sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_K4_slope[[it]] <- c(lower_bound_hat_one_dataset_K4_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =4,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_K4.5_slope[[it]] <- c(lower_bound_hat_one_dataset_K4.5_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =4.5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
        lower_bound_hat_one_dataset_K5_slope[[it]] <- c(lower_bound_hat_one_dataset_K5_slope[[it]],lower_bound_estimated_one_dataset(cste_mult = K,path = path_collection_bounds[[k]],n,q,chosen_cste =5,sigma_2,m=it,cste_mult_vect,list_P_2r,known_variance=FALSE))
      }
    }
